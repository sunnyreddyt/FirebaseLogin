...
import com.spandana.firebaselogin.adapters.TopUpReportDetailsAdapter;
...
public class TopUpReportDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* if (abUtil.isConnectingToInternet()) {
        ...
        new TopUpReportDetails().execute();

    }


    private class TopUpReportDetails extends AsyncTask<String, Integer, String> {
                ...
                if (json.length() > 0) {
                    ...
                    try {
                        ...
                        if (jsonObjectMain.has("Code") && jsonObjectMain.getString("Code").equalsIgnoreCase("200")) {
                            ...
                            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(TopUpReportDetailsActivity.this, LinearLayoutManager.VERTICAL, false);
                            usersRecycleView.setLayoutManager(linearLayoutManager);
                            usersRecycleView.setHasFixedSize(true);
                            TopUpReportDetailsAdapter topUpReportDetailsAdapter = new TopUpReportDetailsAdapter(TopUpReportDetailsActivity.this, jsonArray);
                            usersRecycleView.setAdapter(topUpReportDetailsAdapter);
        ...
        public String postData() {
            ...
            HttpPost httppost = new HttpPost("https://www.esytopup.co.in/mobile_service/Login/topupReports?loginid=112");
